    ...
    <div className="w-full">
      ...
      <div className="relative my-8">
        ...
        <div className="relative flex justify-center text-[9px] uppercase font-black tracking-[0.3em]">
          <span className="bg-transparent px-4 text-slate-600 italic">O accede vía portal</span>
        </div>
      </div>
      ...
      >
        ...
        <span className="text-[10px] tracking-[0.2em] uppercase font-black">Google Auth</span>
      </button>
    </div>
  );
};