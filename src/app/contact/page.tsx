      ...
      <div className="max-w-350 mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-10" data-aos="fade-right">
          <div className="pl-6 border-l-4 border-blue-600">
            ...
            <p className="text-white/70 text-lg max-w-md mt-6 italic">
        ...
        {/* Formulario */}
        <div 
          className="bg-tranparent opacity-100 backdrop-blur-xl border border-white/20 p-10 md:p-14 rounded-[3.5rem] shadow-[0_0_80px_rgba(37,99,235,0.1)]"
          data-aos="fade-left"
        >
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <label className="text-[10px] uppercase font-black text-blue-500 tracking-[0.2em] ml-2">
                  Nombre
                </label>
                <input 
                  name="nombre"
                  ...
                  className="w-full bg-white/20 border border-white/30 rounded-2xl px-5 py-4 text-white outline-none focus:border-blue-500 focus:bg-white/30 transition-all italic font-medium"
                />
              </div>
              <div className="space-y-3">
                <label className="text-[10px] uppercase font-black text-blue-500 tracking-[0.2em] ml-2">
            ...
            <div className="space-y-3">
              ...
              <textarea 
                ...
                className="w-full bg-white/20 border border-white/30 rounded-2xl px-5 py-4 text-white outline-none focus:border-blue-500 focus:bg-white/30 transition-all resize-none italic font-medium"
              ></textarea>
            </div>
